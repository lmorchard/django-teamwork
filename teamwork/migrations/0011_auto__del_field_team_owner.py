...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'teamwork_team', 'owner_id')


    def backwards(self, orm):
        # Adding field 'Team.owner'
        db.add_column(u'teamwork_team', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_teams', null=True, to=orm['auth.User']),
                      keep_default=False)
