...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'teamwork_membership', (
        ...
        db.send_create_signal(u'teamwork', ['Membership'])

        # Removing M2M table for field owners on 'Team'
        db.delete_table(db.shorten_name(u'teamwork_team_owners'))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'teamwork_membership')

        # Adding M2M table for field owners on 'Team'
        m2m_table_name = db.shorten_name(u'teamwork_team_owners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm[u'teamwork.team'], null=False)),
    ...
    models = {
        ...
        u'teamwork.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['teamwork.Membership']", 'symmetrical': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
