...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'teamwork_team', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_teams', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'teamwork.team': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_teams'", 'null': 'True', 'to': u"orm['auth.User']"})
        }
    }
